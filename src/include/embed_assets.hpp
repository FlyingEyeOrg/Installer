...
#define EMBED_FILE(var_name, file_path) \
    ...
    asm(".section .rdata,\"dr\"\n" \
        ".globl binary_" #var_name "_start\n" \
        "binary_" #var_name "_start:\n" \
        "    .incbin \"" file_path "\"\n" \
        ".globl binary_" #var_name "_end\n" \
        "binary_" #var_name "_end:\n" \
        ".globl binary_" #var_name "_size\n" \
        "binary_" #var_name "_size:\n" \
